...
GROOVY_HOME="$HOME/java/groovy-$GROOVY_VERSION"
echo "export GROOVY_HOME=\"$GROOVY_HOME\"" >> $HOME/.bashrc

# Get Maven
wget -nv http://mirrors.koehn.com/apache/maven/maven-3/$MAVEN_VERSION/binaries/apache-maven-$MAVEN_VERSION-bin.zip
unzip apache-maven-$MAVEN_VERSION-bin.zip
MAVEN_HOME="$HOME/java/apache-maven-$MAVEN_VERSION"
echo "export MAVEN_HOME=\"$MAVEN_HOME\"" >> $HOME/.bashrc

# Get jclouds
wget -nv https://raw.githubusercontent.com/rackerlabs/rccc/master/java/pom.xml
